#ifndef __TESTMATRIX_ML_H__
#define __TESTMATRIX_ML_H__
...
#if !defined(PART_OF_TESTMATRIX) && \
    !defined(STATIC_LINK_TESTMATRIX) && \
    !defined(DYNAMIC_LINK_TESTMATRIX)
#define PART_OF_TESTMATRIX
#endif

#if defined(PART_OF_TESTMATRIX)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_TESTMATRIX)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_TESTMATRIX)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for testMatrix
#define MLLIB_PRIVATE(x)
