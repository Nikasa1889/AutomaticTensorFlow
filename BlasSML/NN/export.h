#ifndef __TEST_NN_ML_H__
#define __TEST_NN_ML_H__
...
#if !defined(PART_OF_TEST_NN) && \
    !defined(STATIC_LINK_TEST_NN) && \
    !defined(DYNAMIC_LINK_TEST_NN)
#define PART_OF_TEST_NN
#endif

#if defined(PART_OF_TEST_NN)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_TEST_NN)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_TEST_NN)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for test_NN
#define MLLIB_PRIVATE(x)
