#ifndef __MNIST_TEST_ML_H__
#define __MNIST_TEST_ML_H__
...
#if !defined(PART_OF_MNIST_TEST) && \
    !defined(STATIC_LINK_MNIST_TEST) && \
    !defined(DYNAMIC_LINK_MNIST_TEST)
#define PART_OF_MNIST_TEST
#endif

#if defined(PART_OF_MNIST_TEST)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_MNIST_TEST)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_MNIST_TEST)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for MNIST_test
#define MLLIB_PRIVATE(x)
