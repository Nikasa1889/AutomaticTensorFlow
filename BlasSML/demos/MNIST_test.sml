...
val params:NN.params =  
    {batchsize = 200,   (* number of training cases per batch *)
     nBatches = 300,    (* number of batches *)
     testsize = 1000,  (* number of testing cases *)
	 nTestBatches = 10,
     ...
     layerSizes = [784, 500, 500, 2000, 10], (* structure of network *)
...
val Inputs = [(784, 500, 500, 2000, 10)]
val Validations = [(784, 500, 500, 2000, 10)]
val input_files = [("../datasets/original_mnist/data_train.csv", "../datasets/original_mnist/labels_train.csv", 
        "../datasets/original_mnist/data_test.csv", "../datasets/original_mnist/labels_test.csv")];
...
fun test (I)=
	output_eval_fun(I, main(784.0, 500.0, 500.0, 2000.0, 10.0))
val _ = test(0)